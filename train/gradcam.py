...
#    exec(open('C:/PyTorch/lujiayi/models.py').read())
#    model = EfficientNet_b0(2)
#    model = models.resnet50(pretrained=True)
#    model = torch.load("C:/daten/saved_resnet50")
    model = torch.load("C:/daten/best_resnet_50_on_CRN")
    ...
    #img = cv2.imread("C:/daten/cat.jpg",1)
    img = np.float32(cv2.resize(img, (224, 224))) / 255
    #img = np.float32(cv2.resize(img, (300, 300))) / 255
...
#    plt.imshow(cam_gb)
#    cv2.imwrite('C:/daten/gb.jpg', gb)
#    cv2.imwrite('C:/daten/cam_gb.jpg', cam_gb)
